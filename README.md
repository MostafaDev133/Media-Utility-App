...
A lightweight, desktop application for quick image processing and video format conversions. Built with Python and CustomTkinter.

## Current & Planned Features
* Image format conversions (PNG, JPG, etc.)
* Multi depth-bit conversions options
* Image resolution resizer and compressor
